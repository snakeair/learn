<template>
  <article>
    ...
    <!-- <section class="img-show-main" v-show="imgShow.show" :class="{down: imgShow.down, up: imgShow.up }" >
      <div @click="downFn(imgShow); showFn(indexShow);"  >btn</div>
      <br>
      <div @click="upFn(imgShow); showFn(listShow);"  >up</div>
    </section> -->
